...
def is_ladder(try_capture, game_state, candidate, ladder_stones=None, recursion_depth=50):
    ...
    for ladder_stone in ladder_stones:
        ...
        if try_capture:
            candidates = determine_escape_candidates(game_state, ladder_stone, capture_player)
            attempted_escapes = [  # now try to escape
                is_ladder(False, current_state, escape_candidate, ladder_stone, recursion_depth - 1) 
            ...
            attempted_captures = [
                is_ladder(True, current_state, capture_candidate, ladder_stone, recursion_depth - 1) 
